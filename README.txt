C++ GUI Qt 4 编程 Source Code
=============================

a.k.a. [C++ GUI Qt 4 编程 (豆瓣)](http://book.douban.com/subject/24734031/)

Free download available from [C++ GUI Programming with Qt4, 2nd Edition | InformIT](http://www.informit.com/store/c-plus-plus-gui-programming-with-qt4-9780132354165)，
as mentioned by the author.

这本书的 example 示例代码可以从上面的网站免费下载。
